...
| CI/CD                      | [Gitlab Pipelines](https://docs.gitlab.com/ee/ci/pipelines/) to test and deploy ML code and resources 
                                |

contained in the following files:

```
mlops_example_1        <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_example_1       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
...
│
├── .gitlab                      <- Configuration folder for CI/CD using Gitlab Pipelines.  The CI/CD workflows deploy ML resources defined in the `./resources/*` folder with databricks CLI bundles.
│
...
the [project README](./mlops_example_1/README.md).
...
After that, follow the [ML pull request guide](docs/ml-pull-request.md)
 and [ML resource config guide](mlops_example_1/resources/README.md)  to propose, test, and deploy changes to production ML code (e.g. update model parameters)
or pipeline resources (e.g. use a larger instance type for model training) via pull request.

| Role                          | Goal                                                                         | Docs                                                                                                                                                                |
|-------------------------------|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Data Scientist                | Get started writing ML code for a brand new project                          | [project README](./mlops_example_1/README.md) |
...
| Data Scientist                | Modify production model ML resources, e.g. model training or inference jobs  | [ML resource config guide](mlops_example_1/resources/README.md)  |

## Setting up CI/CD
This stack comes with a workflow to set up CI/CD for projects that can be found in

`.gitlab/pipelines/mlops_example_1-triggers-cicd.yml`.
...
need to run it again for project `mlops_example_1`.
