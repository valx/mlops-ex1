...
# ``mlops_example_1/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_example_1-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_example_1.mlops_example_1-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_example_1.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_example_1.trip_dropoff_features",
