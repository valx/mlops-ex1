...
To push your updated ML code to production, [open a pull request](https://docs.gitlab.com/ee/user/project/merge_requests/
...
Opening a pull request will trigger a[Gitlab Pipeline](../.gitlab/pipelines/mlops_example_1-bundle-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/mlops_example_1/mlops_example_1-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/mlops_example_1/mlops_example_1-model)
. 
